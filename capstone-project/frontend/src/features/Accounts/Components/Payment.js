  ...
  return (
    <>
      ...
      <div className="payment-container">
        ...
        <div
          className={
            paymentMethod == "Credit/Debit Card"
              ? "payment-base payment-highlight"
              : "payment-base"
          }
          onClick={() => updatePaymentMethod("Credit/Debit Card")}
        >
        ...
        <div
          className={
            (paymentMethod = "Google Pay/Apple Pay"
              ? "payment-base payment-highlight"
              : "payment-base")
          }
          onClick={() => updatePaymentMethod("Google Pay/Apple Pay")}
        >
