  ...
  return (
    <table className="plan-table">
      <thead>
        <tr>
          <th></th>
          <th className="plan-table-th" onClick={() => setPlan("Mobile")}>
            Mobile
          </th>
          <th></th>
          <th className="plan-table-th" onClick={() => setPlan("Basic")}>
            Basic
          </th>
          <th></th>
          <th className="plan-table-th" onClick={() => setPlan("Standard")}>
            Standard
          </th>
          <th></th>
          <th className="plan-table-th" onClick={() => setPlan("Premium")}>
            Premium
          </th>
        </tr>
      </thead>
      <tbody>
        {rows.map((row) => (
          <tr key={row.spec}>
            <td>{row.spec}</td>
            <td className="plan_table_td" style={{ color: `${c1}` }}>
              {typeof row.mobile == "number" ? (
                row.mobile ? (
                  <CheckIcon />
                ) : (
                  <CloseIcon />
            ...
            <td></td>
            <td className="plan_table_td" style={{ color: `${c2}` }}>
              {typeof row.basic == "number" ? (
                row.basic ? (
                  <CheckIcon />
                ) : (
                  <CloseIcon />
            ...
            <td></td>
            <td className="plan_table_td" style={{ color: `${c3}` }}>
            ...
            <td></td>
            <td className="plan_table_td" style={{ color: `${c4}` }}>
