      ...
      fetch(process.env.REACT_APP_SERV_BASE_URL + "/users/generate-token", {
        ...
        .then((response) => {
          ...
          if (response.message == "Un Authorized") {
            ...
            fetch(
              process.env.REACT_APP_SERV_BASE_URL + "/profile?id=" + userId,
              {
                method: "GET",
                headers: {
        ...
        <div className="box">
          ...
          {err && (
            <div className="error1">
              {" "}
              {err} <Link to="/login"> create a new account. </Link>{" "}
            </div>
          )}
          ...
          <div>
            <button onClick={handleLogin} className="signin">
              Sign In
            </button>
          </div>
          ...
          <div className="new">
            ...
            <div onClick={() => navigate("/signup")} className="new2">
              Sign up now.
            </div>
          </div>
          <div className="secure">
            <div>
              ...
              bot. <div className="blue">Learn more.</div>{" "}
            </div>
          </div>
        </div>
      </div>
