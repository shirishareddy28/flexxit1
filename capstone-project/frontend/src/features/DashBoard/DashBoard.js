...
import { getMyListMovies, setUserProfile } from "../../Data/hooks/UserSlice";
import MovieList from "../DashBoard/components/MovieList";
import { MovieModal } from "../DashBoard/components/MovieModal";
...
function Dashboad(props) {
  ...
  const { trendingMovies, topRatedMovies, movieDetail, searchResults } =
  ...
  useEffect(() => {
    ...
    const callDispatchMethods = async () => {
      ...
      await dispatch(
        getMyListMovies(
          { ...JSON.parse(localStorage.getItem("userProfile")) }.myList
        )
      );
                ...
                <div className="player">
                  ...
                  <div className="video-info">
                    <div className="synopsis">
                      <p>
                        A large and lovable rabbit deals with three tiny
                        bullies, led by a flying squirrel, who are determined to
                        squelch his happiness.
                      </p>
