...
import { getMoviesBySearchText } from "../../../Data/hooks/movieSlice";
    ...
    <header className={black ? "black" : ""}>
      <div className="nav-bar-bar">
        <div className="header-logo">
          <Link to="/dashboard">
            <img src="/static/Images/flixxit-logo.png" alt="Flixxit" />
          </Link>
        </div>
        {showMenu ? (
          <div className="nav-lg">
            <Link to="/dashboard" className="nav-bar-text-1">
              Home
            </Link>
        ...
        <div className="search-bar-right">
          ...
          {open && (
            <div className="modal-box-profiles">
              <div className="profile-text-bottom" onClick={handleAccount}>
                Account
              </div>
