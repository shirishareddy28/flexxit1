    ...
    <>
      <div className={`${"card-wrapper"} ${applyClass}`}>
        <div className="card">
          ...
          <ul className="icons">
            <li onClick={() => handlePlayVideo(item.id)}>
              <PlayArrowIcon />{" "}
            </li>
            {inList ? (
              <li
              ...
              <li onClick={() => handleAddToList(item.id)}>
                <AddIcon />{" "}
              </li>
            )}
            {liked ? (
              <li style={highlightStyle} onClick={() => handleLike(item.id)}>
                <ThumbUpAltIcon />{" "}
              </li>
            ) : (
              <li onClick={() => handleLike(item.id)}>
                <ThumbUpAltIcon />{" "}
              </li>
            )}

            {disliked ? (
              <li style={highlightStyle} onClick={() => handleDislike(item.id)}>
                <ThumbDownAltIcon />{" "}
              </li>
            ) : (
              <li onClick={() => handleDislike(item.id)}>
                <ThumbDownAltIcon />{" "}
              </li>
            )}
          </ul>
