...
export const updatePlanPaymentMethod = createAsyncThunk(
  "updatePlanPaymentMethod",
  (user) => {
...
export const updateUserProfileLikes = createAsyncThunk(
  "updateUserProfileLikes",
  (user) => {
    return putJsonData(
      "/profile/likes?id=" + user._id + "&field=likes",
      user.likes
    );
  }
);
...
export const updateUserProfileDislikes = createAsyncThunk(
  "updateUserProfileDislikes",
  (user) => {
    return putJsonData(
      "/profile/dislikes?id=" + user._id + "&field=dislikes",
      user.dislikes
    );
  }
);
...
export const updateUserProfileMylist = createAsyncThunk(
  "updateUserProfileMylist",
  (user) => {
    return putJsonData(
      "/profile/mylist?id=" + user._id + "&field=myList",
      user.myList
    );
  }
);
...
export const getMyListMovies = createAsyncThunk(
  "getMyListMovies",
  async (myList) => {
    let tempList = [];
